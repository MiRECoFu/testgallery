...
class AppComponent extends React.Component {
  ...
  constructor(props) {
     ...
     /*
      *翻转图片
      *@param index 输入当前被操作执行inverse的图片信息数组的index值
      *@return {Function} 这是一个闭包函数 期内return真正待被执行的函数
      */
  ...
  render() {
    ...
    return (
      <section className="stage" ref="stage">
        ...
        <div className="corbar">Copyright (c) 2016 MiRECo All Rights Reserved</div>
      </section>
    );
  }
}
